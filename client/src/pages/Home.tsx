          ...
          {differentiatorRows.map((row, i) => (
            <div key={i} style={{ display: "grid", gridTemplateColumns: "180px 1fr 1fr", borderBottom: i < differentiatorRows.length - 1 ? "1px solid rgba(240,223,200,0.06)" : "none", backgroundColor: i % 2 === 0 ? "transparent" : "rgba(255,255,255,0.015)" }}>
              ...
              <div style={{ padding: "20px 24px", borderLeft: "1px solid rgba(240,223,200,0.08)", display: "flex", alignItems: "center", gap: "10px" }}>
                <span style={{ color: "rgba(140,45,30,0.65)", fontSize: "15px", flexShrink: 0 }}>✕</span>
      ...
      <div className="container" style={{ maxWidth: "1280px", marginLeft: "auto", marginRight: "auto", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2px", alignItems: "stretch", marginBottom: "64px" }}>
          {revenueSystemCards.map((card, i) => (
            ...
            >
              {/* hatter6 overlay */}
              <div aria-hidden="true" style={{ position: "absolute", inset: 0, background: "radial-gradient(circle at 100% 0%, rgba(140,45,30,0.65) 0%, transparent 65%)", opacity: 0.85, pointerEvents: "none" }} />
              {/* Top accent line */}
      ...
      <div className="container" style={{ maxWidth: "1280px", marginLeft: "auto", marginRight: "auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "40px" }}>
          ...
          <div style={{ border: "1px solid rgba(240,223,200,0.08)", backgroundColor: "rgba(240,223,200,0.02)", borderBottomLeftRadius: "40px", position: "relative", overflow: "hidden" }}>
            <div aria-hidden="true" style={{ position: "absolute", inset: 0, background: "radial-gradient(circle at 100% 100%, rgba(140,45,30,0.65) 0%, transparent 65%)", opacity: 0.6, pointerEvents: "none" }} />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "2px", marginBottom: "64px" }}>
          ...
          <div className="stat-flip-card" style={{ borderBottomRightRadius: "20px" }}>
            <div className="stat-flip-inner">
              <div aria-hidden="true" style={{ position: "absolute", inset: 0, background: "radial-gradient(circle at 100% 0%, rgba(140,45,30,0.65) 0%, transparent 65%)", opacity: 0.85, pointerEvents: "none", backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden", zIndex: 0 }} />
              {/* Front face */}
          ...
          <div className="stat-flip-card" style={{ borderBottomLeftRadius: "20px" }}>
            <div className="stat-flip-inner">
              <div aria-hidden="true" style={{ position: "absolute", inset: 0, background: "radial-gradient(circle at 0% 0%, rgba(140,45,30,0.65) 0%, transparent 65%)", opacity: 0.85, pointerEvents: "none", backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden", zIndex: 0 }} />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: "48px", alignItems: "start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
            ...
            <div style={{ backgroundColor: "rgba(240,111,102,0.08)", borderLeft: "3px solid #f06f66", padding: "16px 20px", borderBottomRightRadius: "16px", position: "relative", overflow: "hidden" }}>
              <div aria-hidden="true" style={{ position: "absolute", inset: 0, background: "radial-gradient(circle at 100% 100%, rgba(140,45,30,0.65) 0%, transparent 65%)", opacity: 0.85, pointerEvents: "none" }} />
      ...
      {AREA_ITEMS.map((area, i) => (
        <div key={i} className={triggered ? "card-anim-wrap triggered" : "card-anim-wrap"} style={{ animationDelay: `${i * 80}ms` }}>
          <div className="card-hover" style={{ height: "100%", backgroundColor: "rgba(240,223,200,0.03)", borderRight: i % 2 === 1 ? "3px solid rgba(240,111,102,0.25)" : "none", borderLeft: i % 2 === 0 ? "3px solid rgba(240,111,102,0.25)" : "none", padding: "16px 20px", position: "relative", overflow: "hidden" }}>
            <div aria-hidden="true" style={{ position: "absolute", inset: 0, background: "radial-gradient(circle at 0% 0%, rgba(140,45,30,0.65) 0%, transparent 65%)", opacity: 0.85, pointerEvents: "none" }} />
          ...
          {reasons.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                {i === 1 && (
                  <div aria-hidden="true" style={{ position: "absolute", inset: 0, background: "radial-gradient(circle at 0% 100%, rgba(140,45,30,0.65) 0%, transparent 65%)", opacity: 0.85, pointerEvents: "none" }} />
                )}
                {i === 3 && (
                  <div aria-hidden="true" style={{ position: "absolute", inset: 0, background: "radial-gradient(circle at 0% 0%, rgba(140,45,30,0.65) 0%, transparent 65%)", opacity: 0.85, pointerEvents: "none" }} />
                )}
